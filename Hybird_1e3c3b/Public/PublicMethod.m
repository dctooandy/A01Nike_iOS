...
{
//    NSString *startAt = [[[BTTActivityManager sharedInstance] redPacketInfoModel] startAt];
//    NSString *endAt = [[[BTTActivityManager sharedInstance] redPacketInfoModel] endAt];
//    BOOL isBeforeDuration = [PublicMethod checksStartDate:startAt ? startAt:@"2021-01-01"
//                                                  EndDate:endAt ? endAt:BeforeStartDate
//                                               serverTime:[PublicMethod serverTime]];
...
+(int)countDownIntervalWithDurationTag:(BOOL)isActivityDuration
{
    ...
    RedPacketsInfoModel * model = [[BTTActivityManager sharedInstance] redPacketInfoModel];
